    ...
    public function allDebtors(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $query = DB::table('invoices as i')
                ...
                ->selectRaw("i.id, i.invoice_ref_no, i.invoice_date, i.grand_total, i.status,
                    COALESCE(NULLIF(i.invoice_client_name, ''), cc.company_name, CONCAT('Client #', i.client_id)) AS client_name,
                    COALESCE(NULLIF(pm.project_name, ''), NULLIF(i.invoice_purpose, ''), CONCAT('Project #', i.project_id)) AS project_name,
