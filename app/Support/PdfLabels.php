...
class PdfLabels
{
    private const BM = [
        ...
        'proposal_company_services_title' => 'Tentang AMIOSH',
        'proposal_company_services_body' => 'Ditubuhkan pada tahun 2010, AMIOSH ialah penyedia perkhidmatan keselamatan, kesihatan dan alam sekitar pekerjaan di Malaysia. Kami menawarkan penyelesaian pematuhan, latihan, penilaian dan sokongan bersepadu.',
        'proposal_company_services_heading' => 'Perkhidmatan Bersepadu Kami',
        'proposal_osh_consultancy' => 'Konsultansi OSH',
        'proposal_osh_consultancy_list' => 'Audit pematuhan, nasihat risiko dan penyumberan luar profesional OSH',
        'proposal_osh_training' => 'Latihan OSH',
        'proposal_osh_training_list' => 'HIRARC, kerja di tempat tinggi, ruang terkurung dan keselamatan kebakaran',
        'proposal_iso_consultancy' => 'Konsultansi ISO',
        'proposal_iso_consultancy_list' => 'ISO 9001, 14001, 45001 dan sistem pengurusan lain',
        'proposal_occupational_health' => 'Kesihatan Pekerjaan',
        'proposal_occupational_health_list' => 'CHRA, bunyi bising, ergonomik, IAQ dan pemantauan pendedahan',
        'proposal_infrastructure' => 'Infrastruktur',
        'proposal_infrastructure_list' => 'Kerja sivil, penyelenggaraan bangunan, jalan dan landskap',
        'proposal_company_services_cta' => 'Ketahui lebih lanjut tentang perkhidmatan AMIOSH di',
